...
export function RapidKitVSCodeContent() {
  const features = [
    {
      icon: <Layers className="w-6 h-6" />,
      title: 'Workspace & Project Management',
      description: 'Create and manage multiple FastAPI and NestJS projects in organized workspaces with visual interface.',
      items: [
      ...
      <section className="px-6 py-20 max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
            ...
            Intelligent IntelliSense, module browser, and project management in one powerful extension.
          </p>
